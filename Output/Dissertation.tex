...
\renewcommand{\cftchapindent}{0.25in} %Set indents to increase by 0.5 inches per level
\renewcommand{\cftsecindent}{0.75in} %Set indents to increase by 0.5 inches per level
\renewcommand{\cftsubsecindent}{1.25in} %Set indents to increase by 0.5 inches per level
\renewcommand{\cftsubsubsecindent}{1.75in} %Set indents to increase by 0.5 inches per level
\renewcommand{\cftparaindent}{2.25in} %Set indents to increase by 0.5 inches per level
\renewcommand{\cftsubparaindent}{2.75in} %Set indents to increase by 0.5 inches per level
